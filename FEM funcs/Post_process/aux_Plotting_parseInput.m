...
%aux_Plotting_parseInput Auxiliary function.
%
% Parses input data depending on if the mesh msh has a list of rotor elements 
...
if isfield(msh, 'rotel')
    ...
    p_plot = msh.p;
    rotorNodes = unique(msh.t(:,msh.rotel))';;%unique( [msh.t(1,msh.rotel) msh.t(2,msh.rotel) msh.t(3,msh.rotel) ] );
